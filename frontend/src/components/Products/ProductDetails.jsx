...
const ProductDetails = ({ productId }) => {
  ...
  const [enhanceCandle, setEnhanceCandle] = useState(false);
  ...
  const totalPrice = selectedProduct
    ? (Number(selectedProduct.price) + (enhanceCandle ? 3.99 : 0)) * quantity
    : 0;
            ...
            <div className="md:w-1/2 md:ml-10">
                  ...
                  {selectedProduct.colors.map((color) => (
                    <button
                      ...
                      className={`w-8 h-8 rounded-full border ${
                        selectedColor === color ? "border-4 border-gray-100" : "border-gray-300"
                      }`}
              ...
              <div className="mb-4">
                <label className="flex items-center space-x-2 cursor-pointer">
                  <input
                    type="checkbox"
                    checked={enhanceCandle}
                    onChange={(e) => setEnhanceCandle(e.target.checked)}
                  />
                  <span className="text-gray-700">Enhance with Hearts/Leaves (+$3.99)</span>
                </label>
              </div> */}
